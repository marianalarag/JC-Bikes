      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 gap-4">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-blue-900 dark:text-white mt-2">
              Panel Maestro
            </h1>
          ...
          <div className="flex gap-3">
            ...
            <Link
              to="/shop"
              className="px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg transition-colors flex items-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <button
              ...
              className="px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-colors"
            >
              Cerrar sesión
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                <thead className="text-xs uppercase bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="px-6 py-3 text-right rounded-r-lg"
                    >
                      Acciones
                    </th>
                  </tr>
          ...
          {/* Columna: Gestión de Inventario / Productos */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-4">
              Administra los productos de JC Bikes vinculados a las categorías.
            </p>

            {/* Botón para gestionar productos */}
            <Link
              to="/admin/products"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg font-semibold transition-colors text-center"
            >
              Gestionar Productos
            </Link>
